...
const StreamlinedOnboarding: React.FC<StreamlinedOnboardingProps> = ({ onComplete }) => {
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      setSubmissionError(error instanceof Error ? error.message : 'Failed to complete onboarding');
    } finally {
      ...
      case 1: // Welcome
        return (
          <div className="text-center">
            ...
            <div className="rounded-lg bg-[hsl(var(--color-surface-1))] p-4 text-left border border-[hsl(var(--color-border))]">
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-text-light flex items-center gap-2">
                <Info className="h-4 w-4 text-primary" />
                <span>These details help us provide personalized recommendations. (Optional)</span>
              </p>
            </div>
        ...
        {showConfirmation && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" role="dialog" aria-modal="true">
            ...
            >
              ...
              <p className="mb-6 text-text-light">
                You've provided the essential information needed for a personalized health plan. 
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
                <Button
                  ...
                  aria-label="Go back to continue editing"
                >
                  Go Back
                </Button>
                <Button
                ...
                >
                  {saving || isSubmitting ? 'Completing...' : 'Complete Setup'}
                </Button>
              </div>
            </motion.div>
          </div>
